...
เว็บแนะนำที่เที่ยวในประเทศไทย — ค้นหาสถานที่ตามภาค/หมวดหมู่ อ่านบทความท่องเที่ยว
...
└── static/          หน้าเว็บทั้งหมด (14 ไฟล์ HTML) + style.css + script.js + admin.js + รูป
```
